...
- **IP**: tbe.kr
- **SSH**: `sshpass -p 'ec2-user' ssh -o StrictHostKeyChecking=no -o PreferredAuthentications=password ec2-user@tbe.kr`
...
| URL | 설명 |
|-----|------|
| `http://tbe.kr:8087/` | 통합 대시보드 (Basic Auth) |
| `http://tbe.kr:8087/?tab=gfa-manual` | GFA 수동 데이터 처리 |
| `http://tbe.kr:8087/api/health` | API 헬스체크 (인증 면제) |
...
- **허용 IP**: 112.157.162.131, 3.34.119.173, tbe.kr
...
### 방법 1: 대시보드 UI
1. `http://tbe.kr:8087/?tab=gfa-manual` 접속
2. "데이터 현황"에서 누락 확인
